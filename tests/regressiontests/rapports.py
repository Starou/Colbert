...
class RapportsTestCase(unittest.TestCase):
    ...
    def test_rapport_activite(self):
        ...
        rapport = rapport_activite(calendrier, 
                                   ...
                                   "Rapport d'activité - Juin 2012",
                                   "2012-013")
        self.maxDiff = None
        self.assertEqual(rapport, {
            'nb_jours': 6,
            'ref_facture': '2012-013',
            'titre': "Rapport d'activit\xe9 - Juin 2012",
            'detail': [[datetime.date(2012, 6, 1),
                        [{'from': '14.00', 'intitule': 'Stuff', 'to': '15.00'},
                         {'from': '17.00', 'intitule': 'More Stuff', 'to': '18.00'}]],
                       ...
                       [datetime.date(2012, 6, 5),
                        [{'from': None,
                          'intitule': 'A very long task, 3 days long.',
                          'to': None},
                         {'from': '09.00',
                          'intitule': 'Make some coffee',
                          'to': '10.00'},
                         {'from': '10.00', 'intitule': 'Nothing', 'to': '11.00'},
                         {'from': '14.00',
                         ...
                         {'from': '18.00',
                          ...
                          'to': '19.00'},
                         {'from': '19.00',
                          'intitule': 'Add a nice Tweeter button on a random page',
                          'to': '19.30'}]],
                       ...
                       [datetime.date(2012, 6, 13),
                        [{'from': None,
                          'intitule': 'Dreaming all day long...',
                          'to': None}]]],
        })
