...
+--------+---------+--------------+""")
    ...
    def test_decode_as_ecriture(self):
            ...
            "comptes": {
                "4181": {
                    ...
                    "ecritures": [
                        {
                            "date": "01/01/2012", 
                            "intitule": "Prestation MyClient1 d\\u00e9cembre 2011", 
                            "credit": "13156.00"
                        }
                    ]
                }, 
                "706": {
                    ...
                    "ecritures": [
                        ...
                        {
                            "date": "03/01/2012", 
                            "intitule": "Facture 2012-01 MyClient1 Prestation d\\u00e9cembre 2011", 
                            "credit": "11000.00"
                        }, 
                        {
                            "date": "20/03/2012", 
                            "intitule": "Facture 2012-03 MyClient2 Prestation f\\u00e9vrier 2012", 
                            "credit": "11000.00"
                        }
                    ]
                }
        ...
        self.assertEqual(grand_livre, {
            'comptes': {'4181': {'ecritures': [{'credit': Decimal('13156.00'),
                                                   'date': datetime.date(2012, 1, 1),
                                                   'intitule': 'Prestation MyClient1 d\xe9cembre 2011'}],
                                   'nom': 'Clients - Factures \xe0 \xe9tablir',
                                   'solde_crediteur': Decimal('13156.00'),
                                   'solde_debiteur': Decimal('0.00'),
                                   'total_credit': Decimal('13156.00'),
                                   'total_debit': Decimal('0.00')},
                         '706': {'ecritures': [{'date': datetime.date(2012, 1, 1),
                                                  'debit': Decimal('11000.00'),
                                                  'intitule': 'Prestation MyClient1 d\xe9cembre 2011'},
                                                 {'credit': Decimal('11000.00'),
                                                  'date': datetime.date(2012, 1, 3),
                                                  'intitule': 'Facture 2012-01 MyClient1 Prestation d\xe9cembre 2011'},
                                                 {'credit': Decimal('11000.00'),
                                                  'date': datetime.date(2012, 3, 20),
                                                  'intitule': 'Facture 2012-03 MyClient2 Prestation f\xe9vrier 2012'}],
                                  'nom': 'Produits - prestations de services',
                                  'solde_crediteur': Decimal('11000.00'),
                                  'solde_debiteur': Decimal('0.00'),
                                  'total_credit': Decimal('22000.00'),
                                  'total_debit': Decimal('11000.00')}},
