    ...
    def test_check_livre_journal(self):
        ...
        self.assertEqual(
            ...
            [[u'18/03/2011 - Frais de constitution de la société CFE Paris.',
             ...
             [u'02/04/2011 - Capital initial Dép\xf4t de 1500 € par Stanislas Guerra au LCL Ledru Rollin',
              u'OK : débit = crédit (1 500.00).'],
             ...
             [u'02/05/2011 - Abonnement LCL Access', u'OK : débit = crédit (3.00).'],
             ...
             [u'08/08/2011 - Chèque XXXXXXY Cotisation trimestrielle RSI/Prévadiès.',
              u'OK : débit = crédit (393.00).'],
             [u'02/09/2011 - Virement MyClient1 ZZZZZZZZZZZ Facture 2011-01',
              u'OK : débit = crédit (6 960.00).'],
             [u'03/09/2011 - Abonnement LCL Access', u'OK : débit = crédit (3.00).'],
             ...
             [u'06/10/2011 - Chèque WWWWWWW Règlement de la TVA trimestrielle',
              u'OK : débit = crédit (1 240.00).'],
             [u'01/11/2011 - Facture 2011-05 MyClient1 Prestation septembre 2011',
              u'OK : débit = crédit (5 382.00).'],
             [u'17/11/2011 - Chèque ZZZZZZZ Cotisation sociales Urssaf 4ème trimestre.',
              u'OK : débit = crédit (402.00).'],
             [u'01/12/2011 - Abonnement LCL Access', u'OK : débit = crédit (3.00).'],
             ...
             [u'01/01/2012 - Prestation MyClient1 décembre 2011',
              u'OK : débit = crédit (13 156.00).'],
             [u'03/01/2012 - Facture 2012-01 MyClient1 Prestation décembre 2011',
              u'OK : débit = crédit (13 156.00).'],
             [u"01/02/2012 - Restaurant La Tour d'argent Déjeuner d'affaire avec Steve Jobs 0.88€ TVA 19.6% ; 2.90€ TVA 7.0%",
             ...
             {'date': datetime.date(2011, 4, 2),
              u'ecritures': [{u'credit': Decimal('0.00'),
                             ...
                             {u'credit': Decimal('1500.00'),
                              ...
                              'numero_compte_debit': u''}],
              'intitule': u'Capital initial Dép\xf4t de 1500 € par Stanislas Guerra au LCL Ledru Rollin',
